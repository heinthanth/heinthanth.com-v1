    ...
    render() {
        return (
            <section id="about" className="h3x-section h3x-section-single">
                ...
                />
                <h1 className="h3x-section-title">Some Hightlight about Me</h1>
                <p>
                    I'm Hein Thant Maung Maung (
                    <span lang="my">ဟိန်းသန့်မောင်မောင်</span>). A Chinese-Mon
                    mix-blood. Born on May 10<sup>th</sup> 2002.
                </p>
                <p>
                    Studied at Basic Education High School, Ahlat from KG to
                    Grade 8. And, studied Grade 9 and 10 at Parami Private High
                    School, Mawlamyine. Passed Matriculation Examination with 4
                    D, total marks of 501. Interested in Computers and
                    Electronics since I was young. And, now, studying Computer
                    Science at{" "}
                    <a
                ...
                <p>
                    ...
                    Electronic Music with DAW (digital audio workstations). It's
                    my weird future bass track xD
                </p>
                <iframe
                ...
                <p className="h3x-mb-20">
                    And also, I love to do pentesting in my free time. I usually
                    play at{" "}
                    <a
                ...
                />
                <p>
                    Sometime, I like to write articles about something I know.
                    Make sure you subscribe my news letter not to miss my
                    articles xD. Wanna read more about what I master,{" "}
                    <Link
                        to="/skills"
                        className="h3x-more-info-link"
                        data-render-me="true"
