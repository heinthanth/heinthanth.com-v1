...
{{-- <li class="h3x-side-nav-item"><a href="{{ route('april-fool') }}" data-render-me="true">APRIL</a></li> --}}
...
{{-- <li class="h3x-side-nav-item"><a href="/contact" data-render-me="true">CONTACT</a></li> --}}
