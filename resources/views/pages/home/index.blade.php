...
<section id="about" class="h3x-section">
    ...
    <a href="#" class="h3x-more-info-link">read more about me</a>
</section>
<hr class="h3x-section-divider h3x-border-none">
<section id="skills" class="h3x-section h3x-text-align-right">
    ...
    <a href="#" class="h3x-more-info-link">explore more in details</a>
</section>
<hr class="h3x-section-divider h3x-border-none">
...
<hr class="h3x-section-divider h3x-border-none">
<section id="contact" class="h3x-setion">
