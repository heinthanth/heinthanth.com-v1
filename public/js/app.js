...
__webpack_require__(/*! ./special */ "./resources/js/special.js");
...
$(".h3x-sidenav-toggler").click(function () {
...
$(document).on("click", ".h3x-reload-current", function (e) {
  e.preventDefault();
...
window.AprilFoolMessageFormController = function (e) {
  var name = $("#".concat(e.target.id, " [name=\"name\"]")).val();
  var message = $("#".concat(e.target.id, " [name=\"message\"]")).val(); // disable button

  var button = $("#".concat(e.target.id, " [type=\"submit\"]"));
...
$('.h3x-ajax-form').on('submit', function (e) {
  var id = e.target.id;
  var controller = "".concat(id, "Controller");
  var res = window[controller](e);
  return res;
});
